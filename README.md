...
* **Uso de HTML semántico**
  ...
  - [ok ] La aplicación tiene un encabezado conformado por un
  ...
  - [ok ] La aplicación tiene un pie de página conformado por un
